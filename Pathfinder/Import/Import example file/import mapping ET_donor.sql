...
=======
CREATE OR REPLACE VIEW DM.EDITH_DONOR_VW AS
SELECT
--r.wdtr_d_regn,
...
decode(d.d_cmvigg,'POS','Reactive','Neg','Non Reactive','Unknown') as d_cmv_igg, -- positve echt hetzelfde als reactive?
'HLA'                           as d_hla_testname,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,1) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_0,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,2) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_1,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,3) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_2,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,4) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_3,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,5) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_4,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,6) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_5,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,7) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_6,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,8) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_7,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,9) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_8,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,10) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_9,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,11) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_10,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,12) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_11,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,13) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_12,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,14) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_13,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,15) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_14,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,16) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_15,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,17) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_16,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,18) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_17,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,19) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_18,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,20) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_19,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,21) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_20,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,22) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_21,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,23) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_22,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,24) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_23,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,25) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_24,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,26) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_25,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,27) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_26,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,28) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_27,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,29) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_28,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,30) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_29,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,31) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_30,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,32) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_31,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,33) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_32,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,34) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_33,
CASE WHEN REGEXP_INSTR(dhla.dlr_hla_string,'[^ ]+',1,35) = 0 THEN NULL ELSE 'at0004' END as d_genefamily_code_34,
=======
...
<<<<<<< HEAD
REGEXP_COUNT(dhla.dlr_hla_string,'[^ ]+') AS COUNTHLA_ANTIGEN, -- Check if number antigens are not over 35, COLUMN should be deleted before import 
...
FROM             ods_et.ods_reg_kidney_vw fup,
                 ...
                 (select max(dlr_labnum) max_dlr_labnum, dlr_donor max_dlr_donor from ODS_ET.ods_enis_don_hla group by dlr_donor)
WHERE
    fup.transplant_number (+)= tx.txp_regn
    AND d.d_regn =  tx.txp_donor
    and max_dlr_donor (+)= tx.txp_donor
    and dhla.dlr_labnum (+)= max_dlr_labnum
--    and d.d_type_desc = 'Cadaver'
    and fup.occurrence = 'I'
--    and fup.deleted = 'false'
    and fup.followup_center like 'C%'
    order by tx_id asc
=======
